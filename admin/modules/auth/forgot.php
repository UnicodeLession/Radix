        ...
        if (!empty($queryUser)){
            ...
            if ($updateStatus){
                ...
                if ($sendStatus){
                    ...
                    setFlashData('msg', 'Lỗi hệ thống! Bạn không thể sử dụng chức năng này 1');
                    setFlashData('msg_type', 'danger');
                }
            }else{
                setFlashData('msg', 'Lỗi hệ thống! Bạn không thể sử dụng chức năng này 2');
                setFlashData('msg_type', 'danger');
            }
    ...
    <div class="row">
        <div class="col-6" style="margin: 20px auto;">
            ...
            <form action="" method="post">
                ...
                <hr>
                <p class="text-center"><a href="admin?module=auth&action=login">Đăng nhập</a></p>
            </form>
        </div>
    </div>
<?php
