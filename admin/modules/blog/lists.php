                ...
                if (!empty($listBlog)):
                    foreach ($listBlog as $key => $item):
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo getLinkAdmin('blog', 'edit', ['id'=>$item['id']]); ?>"><?php echo $item['title']; ?></a>
                                <br />
                                ...
                                <a href="<?php echo getLinkModule('blog', $item['id'], 'blog', 'slug') ?>" target="_blank" class="btn btn-sm btn-primary" style="padding: 0 10px;" target="_blank">Xem</a>
                            </td>

                            <td>
                                <a href="?<?php echo getLinkQueryString('blog_category_id', $item['category_id']); ?>"><?php echo $item['cate_name']; ?></a>
                            </td>
                            <td>
