    ...
    <section class="content">
        <div class="container-fluid">
            <form action="" method="post">
                ...
                <h5 class="text-primary divide-content">Thiết lập cột 1</h5>
                ...
                <h5 class="text-primary divide-content">Thiết lập cột 2</h5>
                <div class="form-group">
                ...
                <h5 class="text-primary divide-content">Thiết lập cột 3</h5>
                <div class="form-group">
                ...
                <h5 class="text-primary divide-content">Thiết lập cột 4</h5>
                <div class="form-group">
                ...
                <h5 class="text-primary divide-content">Thiết lập bản quyền</h5>
