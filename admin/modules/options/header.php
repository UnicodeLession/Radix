    ...
    <section class="content">
        <div class="container-fluid">
            <form action="" method="post">
                ...
                getMsg($msg, $msgType);
                ?>
                <h5 class="text-primary divide-content">Thiết lập tìm kiếm:</h5>
                ...
                <h5 class="text-primary divide-content">Thiết lập Logo-Favicon:</h5>
                <div class="form-group">
                ...
                <h5 class="text-primary divide-content">Thiết lập khác:</h5>
                <div class="form-group">
