    ...
    <section class="content">
        <div class="container-fluid">
            <form action="" method="post">
                ...
                getMsg($msg, $msgType);
                ?>
                <h5 class="divide-content text-primary ">Thiết lập tiêu đề</h5>
                ...
                <h5 class="divide-content text-primary ">Thiết lập chung</h5>
                <div class="form-group">
                ...
                <h5 class="divide-content text-primary ">Danh sách đội ngũ</h5>
                ...
                <div class="team-wrapper">
                    ...
                    if (!empty($teamContentJson)){
                        ...
                        if (!empty($teamContentArr)){
                            foreach ($teamContentArr as $key => $item){
                                ?>
                                <div class="team-item">
                                    <div class="row" style="margin-top: 20px;">
                                        <div class="" style="padding-left: 8px; margin-right: 10px; ">
                                            <span class="btn btn-info " style="margin-bottom: 10px; width: 6%%">Thành Viên <?php echo $key +1 ?></span>
                                        </div>
