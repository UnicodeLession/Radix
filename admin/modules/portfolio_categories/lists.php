<?php
// cate: portfolio_categories
if (!defined('_INCODE')) die('Access Deined...');
$data = [
    'pageTitle' => 'Danh sách danh mục dự án'
];
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-6">
                    <?php
                    if (!empty($body['view']) & !empty($body['id'])) {
                ...
                <div class="col-6">
                    ...
                    <form action="" method="get">
                        <div class="row">
                            <div class="col-9">
                                <input type="search" name="keyword" class="form-control" placeholder="Nhập tên dự án..."
                    ...
                    <table class="table table-bordered">
                        ...
                        if (!empty($listCate)):
                            foreach ($listCate as $key => $item):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br>
                                        <a href="<?php echo getLinkAdmin('portfolio_categories', '', ['id'=>$item['id'], 'view' => 'duplicate']); ?>" style="padding: 0 5px;" class="btn btn-danger btn-sm">Nhân bản</a></td>
                                    ...
                                    <td class="text-center"><a
                                                href="<?php echo getLinkAdmin('portfolio_categories', '', ['id' => $item['id'], 'view' => 'delete']); ?>"
                            ...
                            ?>
                            <tr>
                                <td colspan="6" class="text-center">Không có danh mục dự án</td>
                            </tr>
                        <?php endif; ?>
                        </tbody>
