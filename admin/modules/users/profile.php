...
if (isPost()){
    ...
    if (empty($errors)){
        ...
        $dataUpdate = [
            ...
            'contact_behance' => $body['contact_behance'],
            ...
            <form action="" method="post">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="">LinkedIn</label>
                            <input type="text" class="form-control" name="contact_behance" placeholder="Behance..." value="<?php echo old('contact_behance', $old); ?>"/>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
