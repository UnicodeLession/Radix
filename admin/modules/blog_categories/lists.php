<?php
// cate: blog_categories
if (!defined('_INCODE')) die('Access Deined...');
$data = [
    'pageTitle' => 'Danh sách danh mục blog'
];
...
//Lấy dữ liệu blog
$listCate = getRaw("SELECT * FROM `blog_categories`  $filter ORDER BY create_at DESC LIMIT $offset, $perPage");
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <form action="" method="get">
                        <div class="row">
                            <div class="col-9">
                                <input type="search" name="keyword" class="form-control" placeholder="Nhập tên blog..."
                    ...
                    <table class="table table-bordered">
                        ...
                        if (!empty($listCate)):
                            foreach ($listCate as $key => $item):
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a
                                            href="<?php echo getLinkAdmin('blog_categories', '', ['id' => $item['id'], 'view' => 'delete']); ?>"
                            ...
                            ?>
                            <tr>
                                <td colspan="6" class="text-center">Không có danh mục blog</td>
                            </tr>
                        <?php endif; ?>
                        </tbody>
